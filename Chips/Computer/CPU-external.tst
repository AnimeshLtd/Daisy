// This file was used to test my CPU design which didn't make use of the built-in ARegister and DRegister. Those two
// chips have special debugging features and the final CPU design uses them.
